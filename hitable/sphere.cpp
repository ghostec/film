...
Sphere::Sphere(math::point3 center, float radius) : center(center), radius(radius) {}
Sphere::~Sphere() {}

HitRecord Sphere::hit(const math::ray& ray, float t_min, float t_max) const {
...
HitRecord Sphere::hit_record_from_parameter(const math::ray& ray, float t) const {
